...
//+------------------------------------------------------------------+
//--- inputs for expert
input string             Expert_Title         ="EMATrend";  // Document name
ulong                    Expert_MagicNumber   =10487;       //
...
input int                Signal_0_MA_PeriodMA =9;           // Moving Average(9,0,MODE_EMA,...) Period of averaging
input int                Signal_0_MA_Shift    =0;           // Moving Average(9,0,MODE_EMA,...) Time shift
input ENUM_MA_METHOD     Signal_0_MA_Method   =MODE_EMA;    // Moving Average(9,0,MODE_EMA,...) Method of averaging
input ENUM_APPLIED_PRICE Signal_0_MA_Applied  =PRICE_CLOSE; // Moving Average(9,0,MODE_EMA,...) Prices series
input double             Signal_0_MA_Weight   =1.0;         // Moving Average(9,0,MODE_EMA,...) Weight [0...1.0]
...
//--- inputs for trailing
input int                Trailing_MA_Period   =9;           // Period of MA
